...
from utils import TimestepEmbedder, modulate, LabelEmbedder, FinalLayer, get_2d_sincos_pos_embed
...
class DiT(nn.Module):
    ...
    Can turn the transformer into a DEQ transformer by setting if_DEQ = True
    """
    def __init__(
        self,
...
def DiT_DEQ_B_4(**kwargs):
    return DiT(if_DEQ = True, depth=12, hidden_size=768, patch_size=4, num_heads=12, **kwargs)
...
def DiT_DEQ_S_8(**kwargs):
    return DiT(if_DEQ = True, depth=12, hidden_size=384, patch_size=8, num_heads=6, **kwargs)
